...
internal class NewCodeBuilder
{
    ...
    public bool BuildPartialCode(out string partialCode)
    {
        ...
        foreach (var stepContext in StepContexts.Where(x => x.GetConditionContext().IsPartial))
        {
            ...
            MemberDeclarationSyntax syntax = stepContext switch
            {
                ...
                PropertyContext propertyContext => (MemberDeclarationSyntax)propertyContext.PropertySymbol.DeclaringSyntaxReferences[0].GetSyntax(),
    ...
    public string BuildCode()
    {
        ...
        var isGlobalNamespace = Type.ContainingNamespace.IsGlobalNamespace;
        var namespaceOpen = isGlobalNamespace ? string.Empty : $"namespace {Type.ContainingNamespace}\n{{";
        var namespaceClose = isGlobalNamespace ? string.Empty : "}";
